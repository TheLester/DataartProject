...
<br/>
<a id="create" href="<c:url value="/create-arrangement"/>">Create Event</a>
<a id="delete" href="<c:url value="/delete-arrangement"/>">Delete Event</a>
<a id="edit"  href="<c:url value="/edit-arrangement"/>">Edit Event</a>
</div>
</div>
</body>
</html>