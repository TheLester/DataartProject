...
public class EvenstPage {
	
	  private final WebDriver driver;
	  private static EvenstPage page;
	  private static String url = "http://localhost:8082/DataartProject/arrangements.html";
	  
	  public EvenstPage(WebDriver driver) {
	        this.driver = driver;
	  ...
	  public static EvenstPage getInstance(WebDriver driver) {
		  driver.get(url);
		  if (page==null)
			  return new EvenstPage(driver);
		  return page;
	  }
